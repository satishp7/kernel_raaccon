...
static ssize_t flash_brightness_store(struct device* dev, struct device_attribute* attr, const char* buf, size_t count) 
{                                                                                                                    
...
static ssize_t flash_brightness_show(struct device* dev, struct device_attribute* attr, char* buf) 
{                                                                                                                    
...
{                                                                                                                    
	...
	gpio_request(pdata->gpio_hwen, "lm3559_en");                                                                   
...
MODULE_DEVICE_TABLE(i2c, id_table_lm3559);
